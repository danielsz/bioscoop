...
simplified Lisp language and outputs FFmpeg's filtergaphs. From the
notoriously complex and error-prone string-based syntax, Bioscoop
reifies the filtergaph into a first-class, composable unit. This in
...
#+HTML: <div style="text-align:center;"><img src="gallery/itsallaboutfilters.jpeg" width="400"/></div>
